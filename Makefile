...
upgrade-dbc-mainnet:
	...
	source .env && forge verify-contract --chain 19850818  --compiler-version v0.8.26 --verifier blockscout --verifier-url $TEST_NET_VERIFIER_URL 0x71E64A1A3D8464B0757FE2Ad2DB124001eaeb842  src/DeepLinkCrownNFT.sol:DeepLinkCrownNFT
